...
The pre-commit hook and pull-request CI automatically increment the patch version and stage
`VERSION` when they detect a required bump. CI commits the generated bump back to
