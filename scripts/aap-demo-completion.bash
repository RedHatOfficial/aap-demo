...
_aap_demo() {
  ...
  commands="deploy deploy-all status clean destroy stop repair setup create watch update config redeploy redeploy-all redhat-status rh-status kubeconfig help"
