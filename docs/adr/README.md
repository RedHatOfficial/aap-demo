...
| [024](024-apme-openshift-template.md) | APME OpenShift Template Deployment | Proposed |
...
7. **019** + **022** + **024** — APME addon, pre-built portal hub, and OpenShift template deploy (if using Ansible Quality)
